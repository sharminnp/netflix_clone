...
class __$$LoadDataInComingSoonCopyWithImpl<$Res>
    extends _$HotAndNewEventCopyWithImpl<$Res, _$LoadDataInComingSoon>
...
class _$LoadDataInComingSoon
    with DiagnosticableTreeMixin
    implements LoadDataInComingSoon {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
        DiagnosticsProperty('type', 'HotAndNewEvent.loadDataInComingSoon'));
  }
...
class _$LoadDataInEveryoneIsWatching
    with DiagnosticableTreeMixin
    implements LoadDataInEveryoneIsWatching {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty(
        'type', 'HotAndNewEvent.loadDataInEveryoneIsWatching'));
  }
...
class _$_Initial with DiagnosticableTreeMixin implements _Initial {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('comingsoonList', comingsoonList))
      ..add(
          DiagnosticsProperty('everyOneIsWatchingList', everyOneIsWatchingList))
